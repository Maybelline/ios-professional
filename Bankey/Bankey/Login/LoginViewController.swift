...
extension LoginViewController{
    ...
    private func layout(){
        ...
        NSLayoutConstraint.activate([
            ...
            loginView.leadingAnchor.constraint(equalToSystemSpacingAfter: view.leadingAnchor, multiplier: 2), // multiplier of 1 is equal to 8 points in iOS programming
...
extension LoginViewController{
    private func animate(){
        ...
        animator4.startAnimation(afterDelay: delay)
    }
}
