...
//  Password
//
//  Created by Maybelline Rivas on 9/29/23.
//
...
extension PasswordStatusView  {
    ...
    func style() {
        ...
        stackView.spacing = 8
        stackView.distribution = .equalCentering // centers the elements in the stackView equally, you can choose other options look at video 180 in Section 23
...
extension PasswordStatusView {
    func updateDisplay(_ text: String) {
        ...
        let lowecaseMet = PasswordCriteria.lowercaseMet(text)
